...
var Shape = function (props) {
    ...
    return (React.createElement("svg", { className: containerClassName, viewBox: box, width: size, height: size, fill: fill, style: __assign({}, (transforms && { transform: transforms })) },
        React.createElement("path", { d: polyPath })));
};
Shape.Triangle = function (props) { return React.createElement(Shape, __assign({}, props, { sides: 3 })); };
Shape.Square = function (props) { return React.createElement(Shape, __assign({}, props, { sides: 4 })); };
Shape.Circle = function (props) { return React.createElement(Shape, __assign({}, props, { sides: 25 })); };
var avoidRerenderIf = function (prevProps, nextProps) {
    return prevProps.sides === nextProps.sides;
};
Shape.Freeze = React.memo(function (props) { return React.createElement(Shape, __assign({}, props)); }, avoidRerenderIf);
